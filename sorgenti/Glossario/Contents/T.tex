...
Tailwind CSS è un framework CSS utilizzato per lo sviluppo di interfacce utente responsive e personalizzabili. In Tailwind CSS, vengono fornite una vasta gamma di classi CSS atomiche, ognuna delle quali rappresenta uno stile CSS specifico. Queste classi possono essere utilizzate direttamente all'interno del markup HTML per applicare stili specifici, come margini, padding, colori, dimensioni dei caratteri, allineamenti, sfondi e molto altro.
\subsection*{Tecnologie} 
 \addcontentsline{toc}{subsection}{Tecnologie}
...
\subsection*{TypeORM} 
 \addcontentsline{toc}{subsection}{TypeORM}
