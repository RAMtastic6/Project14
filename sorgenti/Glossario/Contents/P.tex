...
\subsection*{PB} 
 \addcontentsline{toc}{subsection}{PB}
...
\subsection*{Posta elettronica} 
 \addcontentsline{toc}{subsection}{Posta elettronica}
...
\subsection*{Postcondizioni} 
 \addcontentsline{toc}{subsection}{Postcondizioni}
...
\subsection*{Precondizioni} 
 \addcontentsline{toc}{subsection}{Precondizioni}
...
\subsection*{PostgresSQL} 
 \addcontentsline{toc}{subsection}{PostgresSQL}
...
\subsection*{Prenotazione} 
 \addcontentsline{toc}{subsection}{Prenotazione}
...
\subsection*{Principio di miglioramento continuo} 
 \addcontentsline{toc}{subsection}{Principio di miglioramento continuo}
...
\subsection*{Processo} 
 \addcontentsline{toc}{subsection}{Processo}
...
\subsection*{Processi primari} 
 \addcontentsline{toc}{subsection}{Processi primari}
...
\subsection*{Processi di supporto} 
 \addcontentsline{toc}{subsection}{Processi di supporto}
...
\subsection*{Processi organizzativi} 
 \addcontentsline{toc}{subsection}{Processi organizzativi}
...
\subsection*{Progettazione architetturale} 
 \addcontentsline{toc}{subsection}{Progettazione architetturale}
...
\subsection*{Progettazione dettagliata} 
 \addcontentsline{toc}{subsection}{Progettazione dettagliata}
