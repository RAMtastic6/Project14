...
\begin{itemize}
    ...
    \item Aprire una pull request dal $\textit{branch}_G$ creato al $\textit{branch}_G$ develop;
...
\end{itemize}
Infine, il responsabile approva la pull request associata.
...
\begin{itemize}
    ...
    \item Ridurre al minimo i rischi che potrebbero influire sulla qualità del prodotto;
