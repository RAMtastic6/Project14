...
\usepackage{amsmath, amsthm, amssymb, calrsfs, wasysym, verbatim, bbm, color, graphicx, geometry, fancyhdr, url, multirow, hyperref, longtable, array, colortbl, xcolor}
...
\input{Contents/processi_di_supporto}

\newpage
\section{Processi organizzativi}
\input{Contents/processi_organizzativi}
\end{document}