...
% \textit{Caso d'Uso_G} UC1 - Registrazione come utente base
\input{uc/uc1}

% \textit{Caso d'Uso_G} UC1.1 - Inserimento email
%\input{uc/uc1_1}

%caso d'uso UC1.2 - Inserimento password
%\input{uc/uc1_2}

% \textit{Caso d'Uso_G} UC3 - Inserimento informazioni utente
%\input{uc/uc1_4}

% \textit{Diagramma dei Casi d'Uso_G} UCD2 - \textit{Prenotazione_G} tavolo
\newpage

% \textit{Caso d'Uso_G} UC2 - Registrazione come amministratore
\input{uc/uc2}
\input{uc/uc2_1}

% \textit{Caso d'Uso_G} UC4 - Accettazione richiesta prenotazione
%\input{uc/uc2_2}

% \textit{Caso d'Uso_G} UC5 - Rifiuto richiesta prenotazione
%\input{uc/uc2_3}

%caso d'uso UC2.1 - Ricerca ristorante
%\input{uc/uc2_1}

% \textit{Caso d'Uso_G} UC3 - Ordinazione collaborativa
\input{uc/uc3}

% \textit{Caso d'Uso_G} UC4 - Interazione con lo staff
\input{uc/uc4}
\input{uc/uc4_1}
\input{uc/uc4_2}

% \textit{Caso d'Uso_G} UC5 - Divisione del conto
\input{uc/uc5}

% \textit{Caso d'Uso_G} UC6 - Consultazione delle prenotazioni da parte dell'amministratore
\input{uc/uc6}
...
% \textit{Caso d'Uso_G} UC7 - Inserimento di \textit{Feedback_G} e recensioni
\input{uc/uc7}

% \textit{Caso d'Uso_G} UC8 - Visualizzazione degli ordini di un tavolo
\input{uc/uc8}

% \textit{Caso d'Uso_G} UC9 - Ricerca pasti ordinabili
\input{uc/uc9}
...
%caso d'uso C13 - Rimozione della \textit{Prenotazione_G} del tavolo
\input{uc/uc13}
...
%caso d'uso 19 - Conferma \textit{Prenotazione_G} (utente amministratore)
\input{uc/uc19}

%caso d'uso 20 - Rifiuto \textit{Prenotazione_G} (utente amministratore)
\input{uc/uc20}
...
% \textit{Caso d'Uso_G} 23
\input{uc/uc23}

\input{uc/uc24}

% \textit{Caso d'Uso_G} 25 Inserimento intolleranze
\input{uc/uc25}

% \textit{Caso d'Uso_G} 26 Inserimento informazioni utente
\input{uc/uc26}

% \textit{Caso d'Uso_G} 27 Logout
\input{uc/uc27}

% \textit{Caso d'Uso_G} 28 Annullamento ordinazione
\input{uc/uc28}
...
% \textit{Caso d'Uso_G} 31 Modifica menu' del ristorante
\input{uc/uc31}
...
%caso d'uso E1 - Visualizzazione errore \textit{Feedback_G} non inserito
%\input{uc/ucE1}
...
\begin{longtable}{|p{4cm}|p{12cm}|}
    \hline
    \emph{Fonte} & \centering{\emph{Requisiti}}
    \hline
    \endfirsthead
    \endhead
