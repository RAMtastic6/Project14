...
\begin{itemize}
    \item nel caso in cui l'utente amministratore decida di non rifiutare la prenotazione, ritorna alla lista delle prenotazioni, lasciando la prenotazione inalterata.
\end{itemize}
\newpage
\end{comment}