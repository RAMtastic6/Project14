...
\begin{itemize}
    ...
    \item Vi deve essere almeno una \textit{Prenotazione_G} presente all'interno della lista associata al ristorante.
\end{itemize}
\textbf{Postcondizioni}:
\begin{itemize}
...
\begin{itemize}
    \item nel caso in cui l'utente amministratore decida di non confermare la \textit{Prenotazione_G}, ritorna alla lista delle prenotazioni, lasciando la \textit{Prenotazione_G} inalterata.
\end{itemize}
\newpage
\end{comment}