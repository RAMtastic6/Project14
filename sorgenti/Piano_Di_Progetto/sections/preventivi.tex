...
In questa sezione è presente il \textit{Preventivo_G} orario ed economico parziale scelto per la fase $\textit{RTB}_G$.
\begin{table}[htbp]
    \centering
\begin{spreadtab}{{tabular}{|c|c|c|c|c|c|c|c|}}
    \hline
...
In questa sezione è presente il \textit{Preventivo_G} orario ed economico parziale scelto per la fase $\textit{PB}_G$.
\begin{table}[htbp]
    \centering
\begin{spreadtab}{{tabular}{|c|c|c|c|c|c|c|c|}}
    \hline
