...
v 1.1.0 & 2024-04-27 &   \begin{tabular}[c]{@{}c@{}}
  ...
  \end{tabular}  & \begin{tabular}[c]{@{}c@{}}
    Visentin S.
  \end{tabular} & Correzione di alcuni punti secondo i feedback del prof. Cardin: rettifica funzionamento di UC23; rielaborazione precondizioni UC7; rielaborazione UC8 e UC8.1; correzione UML di UC11; aggiunta di Requisiti di Vincolo\\
\hline 
...
% caso d'uso UC1 - Registrazione come utente base
\input{uc/uc1}

% caso d'uso UC1.1 - Inserimento email
%\input{uc/uc1_1}

%caso d'uso UC1.2 - Inserimento password
%\input{uc/uc1_2}

% caso d'uso UC3 - Inserimento informazioni utente
%\input{uc/uc1_4}

% diagramma dei casi d'uso UCD2 - Prenotazione tavolo
\newpage

% caso d'uso UC2 - Registrazione come amministratore
\input{uc/uc2}
\input{uc/uc2_1}

% caso d'uso UC4 - Accettazione richiesta prenotazione
%\input{uc/uc2_2}

% caso d'uso UC5 - Rifiuto richiesta prenotazione
%\input{uc/uc2_3}

%caso d'uso UC2.1 - Ricerca ristorante
%\input{uc/uc2_1}

% caso d'uso UC3 - Ordinazione collaborativa
\input{uc/uc3}

% caso d'uso UC4 - Interazione con lo staff
\input{uc/uc4}
%\input{uc/uc4_1}
%\input{uc/uc4_1}

% caso d'uso UC5 - Divisione del conto
\input{uc/uc5}

% caso d'uso UC6 - Consultazione delle prenotazioni da parte dell'amministratore
\input{uc/uc6}
...
% caso d'uso UC7 - Inserimento di feedback e recensioni
\input{uc/uc7}

% caso d'uso UC8 - Visualizzazione degli ordini di un tavolo
\input{uc/uc8}

% caso d'uso UC9 - Ricerca pasti ordinabili
\input{uc/uc9}
...
%caso d'uso C13 - Rimozione della prenotazione del tavolo
\input{uc/uc13}
...
%caso d'uso 19 - Conferma prenotazione (utente amministratore)
\input{uc/uc19}

%caso d'uso 20 - Rifiuto prenotazione (utente amministratore)
\input{uc/uc20}
...
% caso d'uso 25 Inserimento intolleranze
\input{uc/uc25}

% caso d'uso 26 Inserimento informazioni utente
\input{uc/uc26}

% caso d'uso 27 Logout
\input{uc/uc27}

% caso d'uso 28 Annullamento ordinazione
\input{uc/uc28}
...
% caso d'uso 31 Modifica menu' del ristorante
\input{uc/uc31}
...
%caso d'uso E1 - Visualizzazione errore feedback non inserito
%\input{uc/ucE1}
