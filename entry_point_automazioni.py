...
PATH_TO_ST_FOLDER = os.path.join(os.getcwd(), "sorgenti", "Specifica Tecnica/")
PATH_TO_MU_FOLDER = os.path.join(os.getcwd(), "sorgenti", "Manuale Utente/")
...
repl_all_occurrences(PATH_TO_GLOSSARY_JSON, "sorgenti/Specifica Tecnica/main.tex", "sorgenti/Specifica Tecnica/sections/")
repl_all_occurrences(PATH_TO_GLOSSARY_JSON, "sorgenti/Manuale Utente/main.tex", "sorgenti/Manuale Utente/sections/")
